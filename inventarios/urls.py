...
urlpatterns = [
    ...
    path('eliminar/<int:articulo_id>/', views.eliminar_articulo, name='eliminar_articulo'),
     path('buscar_articulos_select2/', views.buscar_articulos_select2, name='buscar_articulos_select2'),
    path('filtrar-articulo-tabla/', views.filtrar_articulo_tabla, name='filtrar_articulo_tabla'),
